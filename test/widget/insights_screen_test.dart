...
void main() {
  group('InsightsScreen Widget Tests', () {
    ...
    testWidgets('should show no data message when no events',
        (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget());

      expect(find.text('No data to analyze'), findsOneWidget);
      expect(
          find.text('Import a calendar to see event insights'), findsOneWidget);
      expect(find.byIcon(Icons.insights), findsOneWidget);
    });

    testWidgets('should display overview stats when events exist',
        (WidgetTester tester) async {
    ...
    testWidgets('should display topic cloud when events have titles',
        (WidgetTester tester) async {
      eventProvider.addEventsForTesting(testEvents);
      await tester.pumpWidget(createTestWidget());
    ...
    testWidgets('should show time patterns section',
        (WidgetTester tester) async {
      eventProvider.addEventsForTesting(testEvents);
      await tester.pumpWidget(createTestWidget());
    ...
    testWidgets('should display priority distribution',
        (WidgetTester tester) async {
      eventProvider.addEventsForTesting(testEvents);
      await tester.pumpWidget(createTestWidget());
    ...
    testWidgets('should show interactive topic bubbles',
        (WidgetTester tester) async {
      eventProvider.addEventsForTesting(testEvents);
      await tester.pumpWidget(createTestWidget());
    ...
    testWidgets('should display schedule heatmap', (WidgetTester tester) async {
      ...
      expect(find.text('Daily Schedule Heatmap'), findsOneWidget);
      expect(find.text('Tap any hour to see events • Darker = More Events'),
          findsOneWidget);
    });
