...
void main() {
  group('EventCard Widget Tests', () {
    ...
    testWidgets('should display event time in AM/PM format', (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget(testEvent));
    ...
    testWidgets('should display speaker when available', (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget(testEvent));
    ...
    testWidgets('should show checkbox for selection', (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget(testEvent));
      
      expect(find.byType(Checkbox), findsOneWidget);
    });

    testWidgets('should show priority controls when selected', (WidgetTester tester) async {
    ...
    testWidgets('should show "more" button for long descriptions', (WidgetTester tester) async {
      final longEvent = testEvent.copyWith(
        description: 'This is a very long description that should trigger the more button to appear because it exceeds the character limit we set for showing the more button functionality.',
      );
    ...
    testWidgets('should not show date when showDate is false', (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        home: Scaffold(
          body: EventCard(
            event: testEvent,
    ...
    testWidgets('should handle empty speaker gracefully', (WidgetTester tester) async {
    ...
    testWidgets('should handle empty location gracefully', (WidgetTester tester) async {
